...
function EmptyPeriod() {
  return <p className="py-10 text-center text-xs uppercase tracking-[0.2em] text-muted-foreground">[ NO_DATA // No data for this period ]</p>;
}
    ...
    <div className="text-foreground">
      <div className="mx-auto flex max-w-7xl flex-col px-4 pt-8 sm:px-6 lg:px-8">
        <main className="flex-1 pb-16">
          <p className="text-[10px] uppercase tracking-[0.3em] text-primary">// SYSTEM_STATUS: OPERATIONAL</p>
          <h1 className="mt-1 font-display text-3xl font-bold uppercase tracking-wider text-foreground">
            <span className="text-glow-primary text-primary">Dashboard</span>
          </h1>
              ...
              <div className="mt-4 flex flex-col gap-3">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="flex h-12 items-center justify-center gap-2 whitespace-nowrap rounded-none border border-primary/20 bg-card/80 px-3 text-xs uppercase tracking-widest text-muted-foreground">
                    <Package className="h-4 w-4 shrink-0 text-primary" /> <span className="truncate">All products</span>
                  </div>
                  <div className="flex h-12 items-center justify-center gap-2 whitespace-nowrap rounded-none border border-primary/20 bg-card/80 px-3 text-xs uppercase tracking-widest text-muted-foreground">
                    <SlidersHorizontal className="h-4 w-4 shrink-0 text-primary" /> Filters
                  </div>
