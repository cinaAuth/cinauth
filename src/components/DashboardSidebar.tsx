...
import logoAsset from "@/assets/cinaauth-logo.png.asset.json";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
    ...
    <Sidebar collapsible="offcanvas">
      <SidebarHeader className="px-3 py-4">
        <Link to="/" className="flex items-center gap-2">
          <img src={logoAsset.url} alt="cinaAuth" className="h-8 w-auto" />
        </Link>
      </SidebarHeader>
                    ...
                    <>
                      <div className="flex min-w-0 items-center gap-2">
                        ...
                        <div className="min-w-0">
                          <p className="truncate text-sm font-semibold text-sidebar-foreground">{store.name}</p>
      ...
      <SidebarFooter className="px-3 py-3">
        <div className="flex items-center gap-2 rounded-md border border-sidebar-border bg-sidebar-accent/40 px-2 py-2">
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate text-sm font-medium text-sidebar-foreground">Profile</p>
